...
(function ($, window, document, undefined) {
  ...
  Plugin.prototype = {
    ...
    start: function () {
      ...
      this.interval = setInterval(jQuery.proxy(this._draw, this), 40);
    },
    ...
    getSecondsElapsed: function () {
      return Math.round((new Date().getTime() - this.startedAt.getTime())/40);
    },
    ...
    _draw: function () {
      var secondsElapsed = this.getSecondsElapsed(),
          endAngle = (Math.PI*3.5) - (((Math.PI*2)/(this.settings.seconds*10)) * secondsElapsed);
      this._clearRect();
